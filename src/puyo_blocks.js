...
export const COLORS = {
    A: '#FF0066', // Vivid Hot Pink (Smiling Happy)
    B: '#0066FF', // Vivid Royal Blue (Star Eyes)
    C: '#FFE500', // Vivid Golden Yellow (Cheeky Tongue)
    D: '#00E676', // Vivid Bright Green (Dizzy Spiral)
    E: '#CC00FF'  // Vivid Electric Purple (Cozy Sleepy)
};
...
export function randomBlockPair() {
